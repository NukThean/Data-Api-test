        ...
        CommandLineRunner commandLineRunner(ProductRepository productRepository,
                ...
                return args -> {
                        ...
                        if (count < 2) {
                                ...
                                Vendor vendor = new Vendor("Logiech Cambodia", "Image/Logitech",
                                                true, "Monivong Street #13A", null);
                                ...
                                Product G102 = new Product("G102", "Logitech G102", 10, category,
                                                "200-8000 DPI", null, "Image/G102", createdAt,
                                                updatedAt, true, vendor, null);

                                Product G304 = new Product("G304", "Logitech G304", 10, category,
                                                "12000 DPI", null, "Image/G304", createdAt,
                                                updatedAt, true, vendor, null);
                                ...
                                SalePrice salePrice1 = new SalePrice(G102, // Reference to the
                                                                           // product
                                                1, // minQuantity
                                                10, // maxQuantity
                                ...
                                SalePrice salePrice2 = new SalePrice(G102, // Reference to the
                                                                           // product
                                                11, // minQuantity
                                                50, // maxQuantity
                                ...
                                SalePrice salePrice3 = new SalePrice(G102, // Reference to the
                                                                           // product
                                                51, // minQuantity
                                                100, // maxQuantity
                                ...
                                SalePrice salePrice4 = new SalePrice(G304, // Reference to the
                                                                           // product
                                                1, // minQuantity
                                                null, // maxQuantity
                                ...
                                SalePrice salePrice5 = new SalePrice(G304, // Reference to the
                                                                           // product
                                                10, // minQuantity
                                                null, // maxQuantity
                                ...
                                salePriceRepository.saveAll(
                                                List.of(salePrice1, salePrice2, salePrice3));
                        } ;
                };
        }
}
