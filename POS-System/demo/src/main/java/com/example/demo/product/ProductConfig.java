  ...
  CommandLineRunner commandLineRunner(ProductRepository productRepository,
    ...
    return args -> {
      ...
      if (count < 2) {
        ...
        Product G102 = new Product("G102", "Logitech G102", 10, category, "200-8000 DPI", 15.00f,
            null, "Image/G102", createdAt, updatedAt, true, vendor);

        Product G304 = new Product("G304", "Logitech G304", 10, category, "12000 DPI", 30.00f, null,
